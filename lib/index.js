...
var getBackupData = function (backupID) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, promises_1.readdir)(backups)];
                        case 1:
                            files = _a.sent();
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            getBackupData(backupID)
                ...
                var size = (0, fs_1.statSync)("" + backups + path_1.sep + backupID + ".json").size; // Gets the size of the file using fs
                var backupInfos = {
                    data: backupData,
                    id: backupID,
                    ...
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            ...
                            case 18:
                                ...
                                // Save the backup
                                return [4 /*yield*/, (0, promises_1.writeFile)("" + backups + path_1.sep + backupData.id + ".json", backupJSON, 'utf-8')];
                            case 19:
                                // Save the backup
                                _j.sent();
                                _j.label = 20;
